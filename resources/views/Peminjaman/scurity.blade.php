            ...
            <div class="col-12">
                <div class="card info-card sales-card">
                    ...
                    <div class="card-body p-3">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <button type="button" class="input-group-text btn btn-success"
                                        data-name="cek_assets">Cek Assets</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-3 col-md-4 label">No. Pol</div>
                    ...
                    <div class="card-footer">
                        ...
                        <button type="button" class="btn btn-success" data-name="returned"
                            style="display: none">Returned</button>
                    </div>
                </div>
            </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data['data'] === null) {
                        ...
                        $("[data-name='val_waktu_peminjaman']").text(': ' + data['data'].date_start +
                            ' s/d ' + data['data'].date_end);
                        ...
                        $("[data-name='val_ast_kepemilikan']").text(': ' + data['data']
                        .ast_kepemilikan);
