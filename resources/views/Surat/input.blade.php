                            ...
                            <tbody>
                                ...
                                @foreach($arr as $key => $value)
                                    <tr>
                                        ...
                                        <td>{{$value->notes}}</td>
                                        <td>
                                            {{ \Carbon\Carbon::parse($value->date_release)->isoFormat('dddd, D MMMM YYYY HH:mm:ss') }}
                                        </td>
                                        <td>{{$value->usr_name}}</td>
                                        <td>{{$value->usr_role}}</td>
                                        <td>
                                            {{ \Carbon\Carbon::parse($value->last_update)->isoFormat('dddd, D MMMM YYYY HH:mm:ss') }}
                                        </td>
                                        <td class="text-center">
                                            <button type="button" class="btn btn-outline-info" data-name="" data-item="{{$value->id}}">
                                                Save
                                            </button>

                                            <button type="button" class="btn btn-outline-warning" data-name="" data-item="{{$value->id}}">
                                                Update
                                            </button>
            ...
            <div class="modal-body">
                <div class="card-style">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="" placeholder="" data-name="date_release">
                    </div>
                    <div class="mb-3">
