                            ...
                            <div class="col-6">
                                    ...
                                    <div class="col-12">
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                ...
                                                <select id="inputAsset" class="form-select select2" data-name="data_asset">
                                                    <option>Choose...</option>
                                                    @foreach($asset as $k => $v)
                                                        <option value="{{$v->id}}">{{$v->name}} - {{$v->no_assets}}</option>    
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="text-center">
                                        <button type="button" class="btn btn-primary" data-name="save_data">Submit</button>
